package jasper.basic.io.NIO2.AIO;
...
public class FileDemo {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        asyncFileChannel.write(
                ...
                0,
                asyncFileChannel,
                new CompletionHandler<Integer, AsynchronousFileChannel>() {
                    @Override
                    public void completed(
                            final Integer result, final AsynchronousFileChannel attachment) {
                        System.out.println(
                                "Writing completed asynchronous file... with result bytes written "
                                        + result);
                        try {
                            attachment.close();
                            asyncRead(path);
                    ...
                    @Override
                    public void failed(
                            final Throwable exc, final AsynchronousFileChannel attachment) {
    ...
    public static void asyncRead(Path path) throws IOException, InterruptedException {
        final AsynchronousFileChannel readChannel =
                ...
                new CompletionHandler<Integer, Object[]>() {
                    ...
                    public void completed(final Integer result, final Object[] attachment) {
                        ...
                        AsynchronousFileChannel readChannel =
                                (AsynchronousFileChannel) attachment[0];
                        byteBuffer.flip();
